...
robocopy /njh /njs /np /nfl /ndl %CppRestD% %Output% cpprest141_2_10d* 
robocopy /njh /njs /np /nfl /ndl %CppRestD% %Output% boost*
robocopy /njh /njs /np /nfl /ndl %CppRestD% %Output% SSLEAY32.*
robocopy /njh /njs /np /nfl /ndl %CppRestD% %Output% LIBEAY32.*
robocopy /njh /njs /np /nfl /ndl %CppRestD% %Output% zlibd1.*