...
{
	CameraStartRecordMessage( int CamIndex, int64_t TimestampIn, std::string PathIn ) 
	: Path( PathIn )
...
{
	CameraReconnectMessage( int CamIndex, std::string Error ) : Camera( CamIndex ), Error( Error ) {}
